...
<div class="easyui-layout" data-options="fit:true,border:false,split:true">
	<div  data-options="region:'center',split:true"  > 
		<table id = "request_list" style ="width:100%;height:100%">
		</table> 
	</div>
		 ...
		 <div class="easyui-panel" title="" style="width:100%;padding:10px 15px;">
	        <form id="searchForm" method="post">
	            ...
	            <div style="margin-bottom:10px;margin-left : 10px;display:inline-block;width:200px">
	             ...
	             <div style="margin-bottom:10px;margin-left : 10px;display:inline-block;width:200px">
	                <select id = "searchPaymentStatus" class="easyui-combobox" name="searchPaymentStatus" label="결제 상태" style="width:100%">
	                	 <option value="0">전체</option>
				...
				<div style="margin-bottom:10px;margin-left : 10px;display:inline-block;width:200px">
	                <select id = "searchPaymentType" class="easyui-combobox" name="searchPaymentType" label="결제 유형" style="width:100%">
	                	 <option value="0">전체</option>
