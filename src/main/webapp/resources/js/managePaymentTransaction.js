var columns = [[
	...
	//{field:'check',width:30,align:'center',title : '선택',checkbox : true},
	   // {field:'action',width:20,align:'center', halign : 'center',formatter : projectActionFormatter},
	    ...
	    {field:'paymentApprovalNumber',width:60,align:'center',title : '승인 번호'},
	    {field:'paymentApprovalAmount',width:25,align:'center',title : '승인 금액', formatter : numberBlueFormatter},
	    {field:'paymentApprovalStatus',width:20,align:'center',title : '승인 상태', formatter : PaymentApprovalStatusFormatter},
