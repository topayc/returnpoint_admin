var columns = [[
	...
	//{field:'check',width:30,align:'center',title : '선택',checkbox : true},
	   // {field:'action',width:20,align:'center', halign : 'center',formatter : projectActionFormatter},
	    ...
	    {field:'nodeType',width:20,align:'center',title : '노드',formatter : nodeTypeFormatter ,hidden : false},
	    ...
	    {field:'affiliateName',width:40,align:'center',title : '협력업체 이름', hidden : false},
	    ...
	    {field:'pointBackStatus',width:25,align:'left',title : '적립 상태', formatter : pointBackStatusFormatter},
