...
var columns = [[
	//{field:'check',width:30,align:'center',title : '선택',checkbox : true},
	   // {field:'action',width:20,align:'center', halign : 'center',formatter : projectActionFormatter},
	    ...
	    {field:'accTargetRange',width:55,align:'left',title : '적립 대상',  formatter : accTargetRangeFormatter},
	    {field:'pointBackStatus',width:30,align:'center',title : '적립 상태', formatter : pointBackStatusFormatter},
	    {field:'useStatus',width:35,align:'center',title : '사용 상태', formatter : pointCouponUseStatusFormatter},
	    {field:'couponType',width:40,align:'center',title : '타입',  formatter : pointCouponTypeFormatter},
	    {field:'deliveryStatus',width:30,align:'center',title : '전시 상태', formatter : pointCouponDeliveryStatusFormatter},
