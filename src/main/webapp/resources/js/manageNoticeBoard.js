		columns = [[
	    	//{field:'check',width:30,align:'center',title : '선택',checkbox : true},
			   // {field:'action',width:20,align:'center', halign : 'center',formatter : projectActionFormatter},
			    ...
			    {field:'bbsType1',width:15,align:'center',title : '게시판 종류', formatter : bbsType1Formatter},
			    {field:'bbsType2',width:15,align:'center',title : '세부 타입', formatter : bbsType2Formatter},
			    {field:'title',width:50,align:'left',title : '제목'},
			    {field:'status',width:10,align:'center',title : '상태', formatter : bbsStatusFormatter},
			    {field:'writerNo',width:10,align:'center',title : '작성자 번호', hidden:true},
			    {field:'rerv2',width:10,align:'center',title : '작성자 이름'},
			    {field:'rerv6',width:15,align:'center',title : '작성자 이메일'},
